package com.example.android.farrel_1202150033_modul6;
...
import com.example.android.farrel_1202150033_modul6.adapter.CommentAdapter;
import com.example.android.farrel_1202150033_modul6.model.Comment;
import com.example.android.farrel_1202150033_modul6.model.User;
...
public class DetailPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseComments = FirebaseDatabase.getInstance().getReference(MenuMainActivity.table2).child(id);
        databaseUser = FirebaseDatabase.getInstance().getReference(MenuMainActivity.table3);
